...
<body>
        ...
        <section id="form_section">
            <div class="_form">
                ...
                <form action="login-success.php" method="POST">
                    ...
                    <input type="email" id="email" name="email" <?php echo isset($_SESSION['check']) ? "disabled" : "" ?> required />


                    <label for="message">Password:</label>
                    <input type="password" id="email" name="password" <?php echo isset($_SESSION['check']) ? "disabled" : "" ?> required />

                    <button type="submit" <?php echo isset($_SESSION['check']) ? "disabled" : "" ?>>Login</button>
                    <br>
                    <p> Not a member? Creat account <a href="registration.php"> here </a></p>
                    <?php
                    if (isset($_SESSION['check']) == 1) {
                        ?>
                        <p><a href="logout.php">Reset</a></p>
                        <?php
                    }
                    ?>
                </form>
    ...
    <footer>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: Login</p>
        </div>
    </footer>
</body>
