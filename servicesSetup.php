...
if (isset($_GET['deleteid'])) {
    $did = $_GET['deleteid'];
    $dsql = "DELETE FROM services where id = '$did'";
    if ($conn->query($dsql)) {
        header("location:servicesSetup.php");
    }
}
...
if (isset($_GET['editid'])) {
    $eid = $_GET['editid'];
    $esql = "SELECT * from services where id = '$eid'";
...
<body>
    ...
    <main>
        ...
        <div id="serviceTbl" class="serviceTbl">
            <?php
                            ...
                            if (!isset($_POST['btnSearch'])) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="btnRow"><a class="editBtn" href="servicesSetup.php?editid=<?php echo $row['id'] ?>">
                                                Edit
                                            </a> <a class="deleteBtn"
                                                href="servicesSetup.php?deleteid=<?php echo $row['id'] ?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
    ...
    <footer>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: Services</p>
        </div>
    </footer>
</body>
