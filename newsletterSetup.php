...
if (isset($_GET['deleteid'])) {
    $did = $_GET['deleteid'];
    $dsql = "DELETE FROM newsletter where id = '$did'";
    if ($conn->query($dsql) == true) {
        header('newsletterSetup.php');
    }
}

if (isset($_GET['editid'])) {
    $eid = $_GET['editid'];
    $esql = "SELECT * from newsletter where id = '$eid'";
    $res = $conn->query($esql);
    $row = $res->fetch_assoc();
} else {
...
if (isset($_POST["btnSearch"])) {
    $search = $_POST["search"];
    $sql = "SELECT * FROM newsletter WHERE title LIKE '%" . $search . "%' OR content LIKE '%" . $search . "%'";
...
<body>
    ...
    <main>
        <section id="form_section">
            <div class="_form">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="newsletter_form">
                    ...
                    <textarea id="content" name="content" cols="30" rows="7"
                    ...
                    if (isset($_GET['editid'])) {
                        ...
                        <input type="file" id="img" name="img" <?php echo isset($_GET['editid']) ? "" : "required" ?> />
        ...
        <div id="newsTbl" class="newsTbl">
            ...
            if ($res->num_rows > 0) {
                if (!isset($_GET['editid'])) {
                    ...
                    <table id="newsletter_tbl" class="newsletter_tbl">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Title</th>
                            ...
                            if (!isset($_POST['btnSearch'])) {
                                ...
                                while ($row = $res->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="tbImg"><img src="<?php echo "images\\" . $row['image']; ?>"></td>
                                        <td><?php echo $row['publishdate'] ?></td>
                                        <td class="btnRow"><a class="editBtn"
                                                href="newsletterSetup.php?editid=<?php echo $row['id'] ?>">Edit</a>
                                            <a class="deleteBtn" href="newsletterSetup.php?deleteid=<?php echo $row['id'] ?>">Delete</a>
                                        </td>
                                    </tr>
    ...
    <footer>
            ...
            <div class="admin_footer">
                ...
                <div class="afooter-content">
                    ...
                    <div class="footer_exploremore">
                        <h3>Admin Record</h3>
                        <ul>
                            <li><a href="home.php#services">Services Table</a></li>
                            <li><a href="legislation.php#legis">Newsletter Table</a></li>
                            <li><a href="home.php#newsLetterContent">HowParentHelp Table</a></li>
                            <li><a href="popular_apps.php#pApps">SocialMediaApps Table</a></li>
                            <li><a href="parents-help.php#pHelpBlog">Help/Support Table</a></li>
                            <li><a href="parents-help.php#pHelpBlog">MemberList Table</a></li>
                        </ul>
                    </div>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: NewsLetter</p>
        </div>
    </footer>
</body>
