...
if (isset($_GET['deleteid'])) {
    $did = $_GET['deleteid'];
    $dsql = "DELETE FROM contactus where id = '$did'";
...
if (isset($_POST["btnSearch"])) {
    $search = $_POST["search"];
    $sql = "SELECT * FROM contactus WHERE message LIKE '%" . $search . "%' OR email LIKE '%" . $search . "%'";
...
<body>
                        ...
                        if (!isset($_POST['btnSearch'])) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class="btnRow"><a class="deleteBtn"
                                            href="contactList.php?deleteid=<?php echo $row['id'] ?>">Delete</a>
                                    </td>
    ...
    <footer>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: Help/Support</p>
        </div>
    </footer>
</body>
