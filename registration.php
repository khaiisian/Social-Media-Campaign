    ...
    <section id="form_section">
      ...
      <div class="_form">
        ...
        <form action="#" method="POST">
          ...
          <label for="regSub">Newsletter Subscription:</label>
          <div id="regSub">
            <input type="radio" id="yes" class="radio_" name="sub" value="1" required />
            <label for="yes" class="lbl_sub">Yes</label>
  ...
  <footer>
    <div class="footer_body">
      ...
      <div class="footer_bd2">
        <h2>Contact US</h2>
        <div class="footer_icon"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-envelope-fill"
            viewBox="0 0 16 16">
            <path
        ...
        <div class="footer_icon"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-geo-alt-fill"
            viewBox="0 0 16 16">
    ...
    <div class="footer-foot">
      ...
      <p class="curPage">You Are Here: Registration</p>
    </div>
  </footer>
</body>
