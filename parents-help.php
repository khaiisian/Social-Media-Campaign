...
if (isset($_POST['btnMsg'])) {
    ...
    if ($conn->query($sql)) {
        ...
        header("location:parents-help.php#footer_frm");
    }
}
...
<body>
    ...
    <main>
        <section id="parents-help">
            ...
            if (!isset($_POST['btnSearch']) or (isset($_POST['btnSearch']) and $search == "")) {
                ?>
                <div class="parentHelp_slide">
                    <img src="images/parentslide2.jpg" alt="">
                    <div class="pHelp_txtover">
                        <h1>How Parents Can Help</h1>
                        <h3>Discover essential tips for parents to effectively support and promote healthy social media use
                            among teenagers.</h3>
                        <ul>
                            <li>Learning about the social media networks that your teen utilize.</li>
                            <li>
                                Teach Positive Social Media Manners
                            </li>
                            <li>
                                Educate teen about online privacy and ethical actions.
                            </li>
                        </ul>
                    </div>
                </div>
                <!-- Add more tips or content as needed -->
                <div class="pHelpBlog" id="pHelpBlog">
                    <h2>How Parents Help Content</h2>
    ...
    <footer>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: Parents Help</p>
        </div>
    </footer>
</body>
