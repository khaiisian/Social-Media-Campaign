...
if (isset($_POST['btnMsg'])) {
    ...
    if ($conn->query($sql)) {
        ...
        header("location:popular_apps.php#footer_frm");
    }
}
...
<body>
    ...
    <main>
        <section id="popular_apps">
            <?php
            if (!isset($_POST['btnSearch']) or (isset($_POST['btnSearch']) and $search == "")) {
                ?>
                <div class="apps_slide">
                    <img src="images/papps1.jpg" alt="">
                    <div class="pHelpBlog" id="pApps">
                        <h2>Most Popular Social Media Apps</h2>

                        <div class="pHelpContent">
                            <?php
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <div class="apps">
                                        <div class="app_image">
                                            <img src="<?php echo "images\\" . $row['logo']; ?>"></p>
                                        </div>
                                        <div class="app_txt">
                                            <h3><?php echo $row['name']; ?></h3>

                                            <p><a href="<?php echo $row['link']; ?>">Login Link</a></p>

                                            <p><strong><a href="<?php echo $row['privacylink']; ?>">Privacy Settings</a></strong>
                                            </p>
                                            ...
                                            <h4>Safety Tips</h4>
                                            <ul>
                                                <li><?php echo $row['safetytip1']; ?></li>
                                                <li><?php echo $row['safetytip2']; ?></li>
                                            </ul>
                                        </div>
                                        <!-- <div class="clear"></div> -->
                                    </div>
    ...
    <footer>
        ...
        <div class="footer-foot">
            ...
            <p class="curPage">You Are Here: Popular Apps</p>
        </div>
    </footer>
</body>
